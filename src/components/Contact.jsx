...
const Contact = () => {
  ...
  // Phone call function
  const makePhoneCall = () => {
    window.location.href = 'tel:+201092887320';
  };
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
              ...
              <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-xl">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-lg font-bold">Phone Call</h3>
                      <p className="text-sm opacity-90">Direct voice conversation</p>
                    </div>
                  </div>
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                ...
                <p className="text-xs opacity-80 mt-2">
                  Available during business hours (9 AM - 6 PM GMT+2)
                </p>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp}>
              <div className="bg-gradient-to-br from-blue-700 to-blue-800 rounded-2xl p-6 text-white shadow-xl">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
                  ...
                  <motion.a
                    ...
                    className="px-4 py-2 bg-white text-blue-700 rounded-lg font-medium flex items-center gap-2 shadow-lg hover:shadow-xl transition-all"
                  >
